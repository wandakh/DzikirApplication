...
import com.wanda.idn.dzikirapp.model.Artikel

class MainActivity : AppCompatActivity() {

    private lateinit var llDzikirDoaHarian: LinearLayout
    private lateinit var llDzikirSholat:LinearLayout
    ...
    private fun initView() {
        llDzikirSholat = findViewById(R.id.llDzikirDoaSholat)
        llDzikirSholat.setOnClickListener {
